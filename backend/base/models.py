...
class DemandPattern(models.Model):
    ...
    demand = models.CharField(max_length=256, blank=True)#, validators=int_list_validator)
...
class Game(models.Model):
    ...
    demandpattern = models.ForeignKey(DemandPattern, on_delete=models.PROTECT, related_name='game_demandpattern')
