      ...
      <Accordion.Collapse eventKey={data.game_id}>
        <Card.Body id={"a" + data.game_id}>
          ...
          <ul>
            ...
            <li className="wholesaler_present">
              <h6>Wholesaler present: {data.wholesaler_present}</h6>
            </li>
            <li className="distributor_present">
              <h6>Distributor present: {data.distributor_present}</h6>
            </li>
            <li className="running">
              <h6>
                Running : <span>{data.running}</span>
              </h6>
            </li>
            <li className="demand_pattern">
              <h6>Demand Pattern: {data.demand_pattern}</h6>
            </li>
          ...
          <ul>
            <li className="retailer">
              <h6>Retailer : {data.retailer.student_name}</h6>
            </li>

            {data.distributor_present === "True" && (
              <li className="distributor">
                <h6>Distributor : {data.distributor.student_name}</h6>
              </li>
            )}

            {data.wholesaler_present === "True" && (
              <li className="wholesaler">
                <h6>Wholesaler : {data.wholesaler.student_name}</h6>
              </li>
            )}

            <li className="factory">
              <h6>Factory : {data.wholesaler.student_name}</h6>
            </li>
          </ul>
          <h5>Remarks</h5>
          <button
          ...
          <button
            className="btn btn-danger play_button"
            id="pause_game"
            onClick={pause_this_game}
            data-game_id={data.game_id}
          >
            Pause Game
          </button>
